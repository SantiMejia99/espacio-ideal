      ...
      {items.map((item) => (
        ...
        >
          ...
          <img
            ...
            src={item.image}
            alt={item.name}
            className="relative m-1! h-14 w-14 rounded-full border border-black/40 bg-white object-cover object-top p-0! transition duration-500 group-hover:z-30 group-hover:scale-105"
          />
        </div>
      ))}
    </>
